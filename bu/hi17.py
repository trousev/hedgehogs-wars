...
class World:
        ...
        def draw_pricking(self):
                for t in range (pricking_time):
                        ...
                        for i in self.pricking_hedgehogs:
                                if i[2]==1:
                                        screen.blit(eval("prick_right"), i[0])
                                elif i[2]==-1:
                                        screen.blit(eval("prick_left"), i[0])
                                elif i[1]==1:
                                        screen.blit(eval("prick_down"), i[0])
                                elif i[1]==-1:
                                        screen.blit(eval("prick_up"), i[0])
                        clock.tick(10)
                        pygame.display.update()
                self.pricking_hedgehogs=[]
                        ...
                        for t in range (moving_time):
                              ...
                              if c:
                                      for i in self.flying_cabbage:
                                              i[4][0]+=i[5][0]
                                              i[4][1]+=i[5][1]
                                              screen.blit(eval("flying_cabbage"), i[4])
                              clock.tick(18)
                              pygame.display.update()
        ...
        def draw_dying(self):
                for t in range(dying_time):
                        self.draw_whole_world()
                        for i in (self.ready_to_die):
                                screen.blit(eval("dying_hedgehog_"+str(t)), i.pos)
                        clock.tick(2)
                        pygame.display.update()                
...
class Cell:
        ...
        def get_info(self):
                ...
                return (info)
        def draw(self):
                screen.blit(eval("grass"), self.pos)
                if self.stuff:
                        screen.blit(eval(self.stuff), self.pos)
...
class Hedgehog:
        ...
        def draw(self):
                screen.blit(eval("hedgehog"), self.pos)
        def draw_moving(self, t=0):
                screen.blit(eval("moving_hedgehog_"+str(t%2)), self.pos)
...
screen=pygame.display.set_mode((size_a*cell_size,size_b*cell_size))
...
grass=pygame.image.load('grass.png').convert_alpha(screen)               
cabbage=pygame.image.load('cabbage.png').convert_alpha(screen)
flying_cabbage=pygame.image.load('cabbage.png').convert_alpha(screen)
apple=pygame.image.load('apple.png').convert_alpha(screen)
kit=pygame.image.load('kit.png').convert_alpha(screen)
hedgehog=pygame.image.load('hedgehog.png').convert_alpha(screen)
moving_hedgehog_0=pygame.image.load('moving_hedgehog_0.png').convert_alpha(screen)
moving_hedgehog_1=pygame.image.load('moving_hedgehog_1.png').convert_alpha(screen)
dying_hedgehog_0=pygame.image.load('hedgehog.png').convert_alpha(screen)
prick_right=pygame.image.load('prick_right.png').convert_alpha(screen)
prick_left=pygame.image.load('prick_left.png').convert_alpha(screen)
prick_up=pygame.image.load('prick_up.png').convert_alpha(screen)
prick_down=pygame.image.load('prick_down.png').convert_alpha(screen)

for i in range (my_world.size_a):
        for j in range (my_world.size_b):
                my_world.cells[i][j].draw()
